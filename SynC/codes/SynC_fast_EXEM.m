...
if (strcmp(task, 'val'))
    ...
    save(['../SynC_CV_results/SynC_fast_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type '.mat'],...
        'acc_val', 'opt');
end
...
if (strcmp(task, 'test'))
    if(isempty(direct_test))
        load(['../SynC_CV_results/SynC_fast_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type '.mat'],...
            'acc_val', 'opt');
