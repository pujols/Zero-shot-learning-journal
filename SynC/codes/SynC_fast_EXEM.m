function SynC_fast_EXEM(task, dataset, opt, direct_test, feature_name)
...
%% Data
[Xtr, Ytr, Xte, Yte, attr2, class_order] = data_loader(dataset, opt, feature_name, 'yes'); % EXEM(SynC)
...
if (strcmp(task, 'train'))
    for i = 1 : length(opt.lambda)
        ...
        for j = 1 : nr_fold
            ...
            save(['../SynC_CV_classifiers/SynC_fast_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
...
if (strcmp(task, 'val'))
    ...
    for i = 1 : length(opt.lambda)
        if (strcmp(opt.loss_type, 'struct'))
            load(['../SynC_CV_classifiers/SynC_fast_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
                '_lambda' num2str(opt.lambda(i)) '.mat'], 'W_record');
        elseif exist(['../SynC_CV_classifiers/SynC_fast_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
                '_lambda' num2str(opt.lambda(i)) '.mat'], 'file') == 2
            load(['../SynC_CV_classifiers/SynC_fast_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
                '_lambda' num2str(opt.lambda(i)) '.mat'], 'W_record');
        else
    ...
    save(['../SynC_CV_results/SynC_fast_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type '.mat'], 'acc_val', 'opt');
end

%% testing
if (strcmp(task, 'test'))
    if(isempty(direct_test))
        load(['../SynC_CV_results/SynC_fast_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type '.mat'], 'acc_val', 'opt');
    ...
    if (exist(['../SynC_results/SynC_fast_EXEM_' opt.loss_type '_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
        '_lambda' num2str(lambda) '_Sim_scale' num2str(Sim_scale) '.mat'], 'file') == 2)
        
        disp('load existing file!!');
        load(['../SynC_results/SynC_fast_EXEM_' opt.loss_type '_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
    ...
    save(['../SynC_results/SynC_fast_EXEM_' opt.loss_type '_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
