function SynC_fast_EXEM_GZSL(task, test_type, dataset, opt, direct_test, feature_name)
...
%% Data
[Xtr, Ytr, Xte, Yte, attr2, class_order] = data_loader_GZSL(dataset, opt, feature_name, 'yes'); % mainly for new EXEM
...
if (strcmp(task, 'train'))
    for i = 1 : length(opt.lambda)
        ...
        for j = 1 : nr_fold
            ...
            save(['../SynC_CV_classifiers/SynC_fast_GZSL_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
...
if (strcmp(task, 'val'))
    ...
    for i = 1 : length(opt.lambda)
        if (strcmp(opt.loss_type, 'struct'))
            load(['../SynC_CV_classifiers/SynC_fast_GZSL_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
                '_lambda' num2str(opt.lambda(i)) '.mat'], 'W_record');
        elseif exist(['../SynC_CV_classifiers/SynC_fast_GZSL_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_'...
                Sim_type '_lambda' num2str(opt.lambda(i)) '.mat'], 'file') == 2
            load(['../SynC_CV_classifiers/SynC_fast_GZSL_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
                '_lambda' num2str(opt.lambda(i)) '.mat'], 'W_record');
        else
    ...
    save(['../SynC_CV_results/SynC_fast_GZSL_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type '.mat'],...
...
if (strcmp(task, 'test'))
    if(isempty(direct_test))
        load(['../SynC_CV_results/SynC_fast_GZSL_EXEM_' opt.loss_type '_classCV_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type '.mat'],...
            'acc_val', 'opt', 'HM_val', 'fixed_bias_val');
    ...
    if (exist(['../SynC_results/SynC_fast_GZSL_EXEM_' test_type '_' opt.loss_type '_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
        '_lambda' num2str(lambda) '_Sim_scale' num2str(Sim_scale) '.mat'], 'file') == 2)
        
        disp('load existing file!!');
        load(['../SynC_results/SynC_fast_GZSL_EXEM_' test_type '_' opt.loss_type '_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
    ...
    save(['../SynC_results/SynC_fast_GZSL_EXEM_' test_type '_' opt.loss_type '_' dataset '_split' num2str(opt.ind_split) '_' feature_name '_' norm_method '_' Sim_type...
        '_lambda' num2str(lambda) '_Sim_scale' num2str(Sim_scale) '.mat'], 'W', 'V', 'lambda', 'Sim_scale', 'acc_te', 'HM', 'auc_record');
end
